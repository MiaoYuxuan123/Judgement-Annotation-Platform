INSERT IGNORE INTO sys_user (id, username, password_hash, real_name, role, can_create_task, status) VALUES
...
INSERT IGNORE INTO guide_version (id, version_name, description, created_at) VALUES
(1, 'V1.0 标准指南', '默认裁判文书论证标签体系', '2026-05-01 00:00:00');

INSERT IGNORE INTO label_l1 (guide_version_id, name, abbr, description) VALUES
(1, '个别事实判断', 'SF', '关于案件中个别对象的事实判断'),
(1, '一般事实判断', 'GF', '为规范适用提供经验或背景支撑'),
(1, '个别规范判断', 'SM', '体现法院对本案的规范性评价'),
(1, '一般规范判断', 'GM', '构成法律论证的规范基础');

INSERT IGNORE INTO label_l2 (guide_version_id, parent_l1_id, name, abbr, description) VALUES
...
INSERT IGNORE INTO relation_type (guide_version_id, name, abbr, description, is_binary) VALUES
...
INSERT IGNORE INTO global_document (id, title, file_name, file_type, extracted_text) VALUES
...
INSERT IGNORE INTO task (id, title, description, status, creator_id, guide_version_id, created_at, stage_changed_at) VALUES
...
INSERT IGNORE INTO task_member (task_id, user_id, role_in_task) VALUES
(1001, 3, '标注员'), (1001, 4, '标注员'), (1001, 5, '裁定者'),
(1002, 3, '标注员'), (1002, 4, '标注员'), (1002, 5, '裁定者'),
(1003, 3, '标注员'), (1003, 4, '标注员'), (1003, 5, '裁定者');

INSERT IGNORE INTO task_document (task_id, source_type, global_doc_id, file_name, status) VALUES
...
INSERT IGNORE INTO arbitration_snapshot (task_id, task_document_id, arbitrator_id, adopted_from, final_result, arbitrated_at) VALUES
